...
Shader "s_Lit4"
{
	Properties
	{
		...
		[ASEBegin]_ataquebosstextura("ataque boss textura", 2D) = "white" {}
		[ASEEnd]_dir("dir", Vector) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 uv_ataquebosstextura = v.texcoord.xy * _ataquebosstextura_ST.xy + _ataquebosstextura_ST.zw;
				float4 tex2DNode11 = tex2Dlod( _ataquebosstextura, float4( uv_ataquebosstextura, 0, 0.0) );
				...
				float3 vertexValue = ( tex2DNode11.r * ( _dir + float3( 0,0,0 ) ) );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float2 uv_ataquebosstextura = v.ase_texcoord.xy * _ataquebosstextura_ST.xy + _ataquebosstextura_ST.zw;
				float4 tex2DNode11 = tex2Dlod( _ataquebosstextura, float4( uv_ataquebosstextura, 0, 0.0) );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 uv_ataquebosstextura = v.texcoord0.xy * _ataquebosstextura_ST.xy + _ataquebosstextura_ST.zw;
				float4 tex2DNode11 = tex2Dlod( _ataquebosstextura, float4( uv_ataquebosstextura, 0, 0.0) );
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;18;-1810.867,-444.4436;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NoiseGeneratorNode;19;-1488.95,-393.5099;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-1756.393,-183.7499;Inherit;False;Property;_scale;scale;6;0;Create;True;0;0;0;False;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;-1974.343,-393.7347;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;22;-2245.868,-341.7616;Inherit;False;Property;_speed1;speed;3;0;Create;True;0;0;0;False;0;False;0,-1;0.2,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleAddOpNode;23;-600.6,48.59715;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.Vector3Node;24;-859.5745,87.94545;Inherit;False;Property;_dir;dir;1;0;Create;True;0;0;0;False;0;False;0,0,0;0,0.2,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SamplerNode;25;-652.6896,303.5807;Inherit;True;Property;_flowmap2;flow map2;4;0;Create;True;0;0;0;False;0;False;-1;None;4c0b758ce30547240a7b7cd99bdb34f9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;26;-1005.803,325.022;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleTimeNode;27;-1355.378,342.921;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
