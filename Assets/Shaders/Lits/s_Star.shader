...
Shader "s_Lit1"
{
	Properties
	{
		...
		[ASEBegin]_pentagramatextura("pentagrama textura", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 color15 = IsGammaSpace() ? float4(2,0,0,0) : float4(4.594794,0,0,0);
				float2 texCoord16 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord21 = IN.ase_texcoord8.xy * float2( 1,1 ) + ( _TimeParameters.x * _speedR );
				float cos18 = cos( 1.0 * _Time.y );
				float sin18 = sin( 1.0 * _Time.y );
				float2 rotator18 = mul( texCoord21 - _anchor , float2x2( cos18 , -sin18 , sin18 , cos18 )) + _anchor;
				float2 lerpResult17 = lerp( texCoord16 , rotator18 , _intensidad);
				float4 tex2DNode10 = tex2D( _pentagramatextura, lerpResult17 );
				float4 lerpResult11 = lerp( float4( 0,0,0,0 ) , color15 , tex2DNode10);
				...
				float Occlusion = 1;
				float Alpha = ( 1.0 - step( tex2DNode10 , temp_cast_1 ) ).r;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 texCoord21 = IN.ase_texcoord2.xy * float2( 1,1 ) + ( _TimeParameters.x * _speedR );
				float cos18 = cos( 1.0 * _Time.y );
				float sin18 = sin( 1.0 * _Time.y );
				float2 rotator18 = mul( texCoord21 - _anchor , float2x2( cos18 , -sin18 , sin18 , cos18 )) + _anchor;
				float2 lerpResult17 = lerp( texCoord16 , rotator18 , _intensidad);
				...
				float Alpha = ( 1.0 - step( tex2DNode10 , temp_cast_0 ) ).r;
				float AlphaClipThreshold = _clip;
				float AlphaClipThresholdShadow = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord21 = IN.ase_texcoord4.xy * float2( 1,1 ) + ( _TimeParameters.x * _speedR );
				float cos18 = cos( 1.0 * _Time.y );
				float sin18 = sin( 1.0 * _Time.y );
				float2 rotator18 = mul( texCoord21 - _anchor , float2x2( cos18 , -sin18 , sin18 , cos18 )) + _anchor;
				float2 lerpResult17 = lerp( texCoord16 , rotator18 , _intensidad);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord21 = IN.ase_texcoord.xy * float2( 1,1 ) + ( _TimeParameters.x * _speedR );
				float cos18 = cos( 1.0 * _Time.y );
				float sin18 = sin( 1.0 * _Time.y );
				float2 rotator18 = mul( texCoord21 - _anchor , float2x2( cos18 , -sin18 , sin18 , cos18 )) + _anchor;
				float2 lerpResult17 = lerp( texCoord16 , rotator18 , _intensidad);
				...
				surfaceDescription.Alpha = ( 1.0 - step( tex2DNode10 , temp_cast_0 ) ).r;
...
Node;AmplifyShaderEditor.SamplerNode;10;-1400.553,19.62137;Inherit;True;Property;_pentagramatextura;pentagrama textura;0;0;Create;True;0;0;0;False;0;False;-1;None;b19c904c26e95f2448ce4bea6e806d42;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;11;-877.782,-2.741692;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StepOpNode;12;-1068.017,219.5825;Inherit;True;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;13;-805.2155,236.59;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-820.9625,472.1883;Inherit;False;Property;_clip;clip;3;0;Create;True;0;0;0;False;0;False;0;0.5734552;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;15;-1280.346,-160.5056;Inherit;False;Constant;_Color1;Color 1;1;1;[HDR];Create;True;0;0;0;False;0;False;2,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;16;-2090.196,-158.3987;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;17;-1749.367,9.601768;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RotatorNode;18;-2099.661,33.17126;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;-2550.217,136.6715;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleTimeNode;20;-2851.385,99.90117;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;21;-2394.381,15.85426;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;22;-2317.74,212.5283;Inherit;False;Property;_anchor;anchor;4;0;Create;True;0;0;0;False;0;False;0.5,0.5;0.5,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;23;-1350.365,393.9412;Inherit;False;Property;_scale;scale;1;0;Create;True;0;0;0;False;0;False;0;0.06367473;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;24;-2787.743,245.4131;Inherit;False;Property;_speedR;speedR;2;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;25;-2022.315,301.6517;Inherit;False;Property;_intensidad;intensidad;5;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=E77A1F87EA91A6BDB49EBED5812CEE1B5F66B345