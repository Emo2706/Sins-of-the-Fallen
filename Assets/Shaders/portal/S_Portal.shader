...
Shader "S_Portal"
{
	Properties
	{
		...
		[ASEBegin]_portaltextura1("portal textura", 2D) = "white" {}
		[ASEEnd]_intensidad3("intensidad2", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 color90 = IsGammaSpace() ? float4(0,0,0,0) : float4(0,0,0,0);
				float4 color91 = IsGammaSpace() ? float4(1.304119,0.225319,0,0) : float4(1.793486,0.04154896,0,0);
				float2 texCoord81 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float cos78 = cos( ( _TimeParameters.x * 10.0 ) );
				float sin78 = sin( ( _TimeParameters.x * 10.0 ) );
				float2 rotator78 = mul( texCoord81 - float2( 0.5,0.5 ) , float2x2( cos78 , -sin78 , sin78 , cos78 )) + float2( 0.5,0.5 );
				float2 center45_g1 = float2( 0.5,0.5 );
				float2 delta6_g1 = ( rotator78 - center45_g1 );
				float angle10_g1 = ( length( delta6_g1 ) * 29.2 );
				...
				float2 lerpResult85 = lerp( texCoord81 , appendResult44_g1 , _intensidad3);
				float4 lerpResult92 = lerp( color90 , color91 , tex2D( _portaltextura1, lerpResult85 ));
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;61;-1717.741,972.8049;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;60;-1376.913,1140.806;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;67;-3106.451,1517.328;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;65;-3273.815,1528.811;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleTimeNode;66;-3482.268,1533.716;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;68;-3475.976,1642.653;Inherit;False;Property;_speed;speed;7;0;Create;True;0;0;0;False;0;False;0,0;0.1,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SamplerNode;63;-2724.458,1469.466;Inherit;True;Property;_flowmap4;flow map4;9;0;Create;True;0;0;0;False;0;False;-1;a81570146b0fd574680f11706c89e74b;a81570146b0fd574680f11706c89e74b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;70;-3101.636,1778.795;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;71;-3269,1790.278;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleTimeNode;72;-3477.451,1795.183;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;74;-2719.642,1730.932;Inherit;True;Property;_flowmap5;flow map4;10;0;Create;True;0;0;0;False;0;False;-1;a81570146b0fd574680f11706c89e74b;a81570146b0fd574680f11706c89e74b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;73;-3471.159,1906.652;Inherit;False;Property;_speed2;speed2;8;0;Create;True;0;0;0;False;0;False;0,0;-0.1,-0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleAddOpNode;75;-2323.285,1584.703;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;51;-1766.897,1403.57;Inherit;False;Property;_intensidad;intensidad;4;0;Create;True;0;0;0;False;0;False;1;0.8313674;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;69;-1732.706,1162.534;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;10;-1077.01,1149.689;Inherit;True;Property;_portaltextura;portal textura;0;0;Create;True;0;0;0;False;0;False;-1;fe3e7e1279de858468ef52bc770a8125;fe3e7e1279de858468ef52bc770a8125;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;76;-2280.895,1392.281;Inherit;False;Property;_intensidad2;intensidad2;5;0;Create;True;0;0;0;False;0;False;1;0.05816559;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RotatorNode;45;-2216.457,1076.702;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;47;-2667.013,1180.202;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleTimeNode;50;-2968.18,1143.432;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;46;-2511.177,1059.385;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;52;-2434.536,1256.058;Inherit;False;Property;_anchor;anchor;3;0;Create;True;0;0;0;False;0;False;0.5,0.5;0.5,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;48;-2871.877,1251.992;Inherit;False;Property;_speedR;speedR;2;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.ColorNode;90;-644.8963,-330.8788;Inherit;False;Constant;_Color2;Color 0;1;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;92;-375.8396,-16.97892;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;93;-655.9554,1167.008;Inherit;False;portal1;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;85;-1315.263,90.38728;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;87;-2071.675,270.3906;Inherit;False;Constant;_strengthT;strengthT;10;0;Create;True;0;0;0;False;0;False;29.2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;79;-2317.066,184.1042;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;80;-2618.234,147.334;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;86;-2534.752,306.0579;Inherit;False;Constant;_speedT;speedT;10;0;Create;True;0;0;0;False;0;False;10;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;77;-1769.804,95.29469;Inherit;True;Twirl;-1;;1;90936742ac32db8449cd21ab6dd337c8;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT;0;False;4;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;81;-2256.956,-28.25466;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RotatorNode;78;-1980.57,40.80102;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0.5,0.5;False;2;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;84;-987.6136,71.01273;Inherit;True;Property;_portaltextura1;portal textura;1;0;Create;True;0;0;0;False;0;False;-1;fe3e7e1279de858468ef52bc770a8125;fe3e7e1279de858468ef52bc770a8125;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WireNode;88;-1652.622,-2.29344;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;95;-855.6053,321.0097;Inherit;False;93;portal1;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;91;-740.2153,-137.6428;Inherit;False;Constant;_Color3;Color 1;1;1;[HDR];Create;True;0;0;0;False;0;False;1.304119,0.225319,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;94;-586.9794,170.99;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;89;-1602.87,327.2257;Inherit;False;Property;_intensidad3;intensidad2;6;0;Create;True;0;0;0;False;0;False;1;0.04;0;1;0;1;FLOAT;0
WireConnection;1;2;92;0
WireConnection;60;0;61;0
WireConnection;60;1;69;0
WireConnection;60;2;51;0
...
ASEEND*/
//CHKSM=C313040587F04CB9DF7BCB19C2B73ED369BE9695