	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 color35 = IsGammaSpace() ? float4(3.211117,0,2.958935,0) : float4(13.02098,0,10.87672,0);
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float3 ase_worldNormal = IN.ase_texcoord3.xyz;
				float fresnelNdotV36 = dot( ase_worldNormal, ase_worldViewDir );
				float fresnelNode36 = ( 0.0 + _scaleF * pow( 1.0 - fresnelNdotV36, _power ) );
				float4 lerpResult39 = lerp( float4( 0,0,0,0 ) , color35 , fresnelNode36);
				...
				float4 lerpResult27 = lerp( float4( 0,0,0,0 ) , lerpResult39 , simplePerlin2D13);
				float4 TwirlNoise41 = lerpResult27;
				...
				float Alpha = ( 1.0 - step( TwirlNoise41 , temp_cast_1 ) ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float Alpha = ( 1.0 - step( TwirlNoise41 , temp_cast_0 ) ).r;
				float AlphaClipThreshold = _clip;
				float AlphaClipThresholdShadow = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = ( 1.0 - step( TwirlNoise41 , temp_cast_0 ) ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float fresnelNdotV36 = dot( IN.normalWS, ase_worldViewDir );
				float fresnelNode36 = ( 0.0 + _scaleF * pow( 1.0 - fresnelNdotV36, _power ) );
				float4 lerpResult39 = lerp( float4( 0,0,0,0 ) , color35 , fresnelNode36);
				float2 texCoord47_g1 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 center45_g1 = float2( 7.3,5.46 );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;S_efecto bola2;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;23;Surface;0;0;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;False;True;True;True;True;False;;False;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;41;-328.0746,-662.791;Inherit;False;TwirlNoise;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;49;-864.2296,47.51611;Inherit;False;41;TwirlNoise;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;46;-884.6233,179.3008;Inherit;False;Property;_scale;scale;2;0;Create;True;0;0;0;False;0;False;0.1706263;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;12;-1684.718,-486.4488;Inherit;True;Twirl;-1;;1;90936742ac32db8449cd21ab6dd337c8;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT;0;False;4;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;13;-1320.369,-532.6721;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-1852.395,-350.9567;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleTimeNode;15;-2190.836,-483.1856;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;18;-1917.521,-575.0043;Inherit;False;Constant;_twirlcenter;twirl center;2;0;Create;True;0;0;0;False;0;False;7.3,5.46;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;24;-1916.934,-436.8641;Inherit;False;Constant;_strengthtwirl;strength twirl;2;0;Create;True;0;0;0;False;0;False;0.4;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-1489.276,-231.4589;Inherit;False;Constant;_scalenoise;scale noise;2;0;Create;True;0;0;0;False;0;False;10;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;27;-696.9255,-698.2474;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.Vector2Node;17;-2078.503,-335.4513;Inherit;False;Constant;_twirlspeed;twirl speed;2;0;Create;True;0;0;0;False;0;False;3,3;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.FresnelNode;36;-1544.282,-832.648;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;37;-1766.052,-708.0828;Inherit;False;Property;_power;power;0;0;Create;True;0;0;0;False;0;False;2.02;1.54;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;38;-1793.654,-825.452;Inherit;False;Property;_scaleF;scaleF;1;0;Create;True;0;0;0;False;0;False;0;0.31;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;39;-1177.366,-819.477;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;35;-1452.742,-1069.096;Inherit;False;Constant;_Color1;Color 0;6;1;[HDR];Create;True;0;0;0;False;0;False;3.211117,0,2.958935,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;42;-212.8088,-48.20563;Inherit;False;41;TwirlNoise;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;53;-261.7494,58.74649;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StepOpNode;51;-519.4435,49.48808;Inherit;True;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;48;-407.4077,315.9105;Inherit;False;Property;_clip;clip;3;0;Create;True;0;0;0;False;0;False;0;0.03948747;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=8F3DC760423B40B7DF35BC8BEEE6C30257E8B35F