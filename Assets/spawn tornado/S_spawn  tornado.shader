...
Shader "S_spawn  tornado"
{
	Properties
	{
		...
		_warningtornadotextura2("warning tornado textura2", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			sampler2D _warningtornadotextura2;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 color18 = IsGammaSpace() ? float4(2.870588,0.07514629,0,0) : float4(10.17504,0.006589165,0,0);
				float4 color26 = IsGammaSpace() ? float4(1,0.8404344,0,0) : float4(1,0.6746448,0,0);
				float2 texCoord13 = IN.ase_texcoord3.xy * float2( 1,1 ) + ( _TimeParameters.x * _speed1 );
				float2 texCoord54 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float cos55 = cos( ( _TimeParameters.x * -10.0 ) );
				float sin55 = sin( ( _TimeParameters.x * -10.0 ) );
				float2 rotator55 = mul( texCoord54 - float2( 0.5,0.5 ) , float2x2( cos55 , -sin55 , sin55 , cos55 )) + float2( 0.5,0.5 );
				float2 center45_g2 = float2( 0.5,0.5 );
				float2 delta6_g2 = ( rotator55 - center45_g2 );
				float angle10_g2 = ( length( delta6_g2 ) * 12.92 );
				...
				float2 lerpResult48 = lerp( texCoord54 , appendResult44_g2 , _intensidad3);
				float simplePerlin2D63 = snoise( lerpResult48*1.0 );
				simplePerlin2D63 = simplePerlin2D63*0.5 + 0.5;
				float4 tex2DNode24 = tex2D( _warningtornadotextura2, ( texCoord13 + simplePerlin2D63 ) );
				float4 lerpResult20 = lerp( color18 , color26 , tex2DNode24);
				...
				float Alpha = step( tex2DNode24 , temp_cast_1 ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord13 = IN.ase_texcoord2.xy * float2( 1,1 ) + ( _TimeParameters.x * _speed1 );
				...
				float Alpha = step( tex2DNode24 , temp_cast_0 ).r;
				float AlphaClipThreshold = _clip;
				float AlphaClipThresholdShadow = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord13 = IN.ase_texcoord.xy * float2( 1,1 ) + ( _TimeParameters.x * _speed1 );
				...
				surfaceDescription.Alpha = step( tex2DNode24 , temp_cast_0 ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord13 = IN.ase_texcoord1.xy * float2( 1,1 ) + ( _TimeParameters.x * _speed1 );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;S_spawn  tornado;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;23;Surface;0;0;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;False;True;True;True;True;False;;False;0
...
Node;AmplifyShaderEditor.LerpOp;20;-495.8414,-187.1317;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-1083.69,317.6317;Inherit;False;Property;_scale;scale;2;0;Create;True;0;0;0;False;0;False;0;0.542972;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-654.2733,387.6136;Inherit;False;Property;_clip;clip;1;0;Create;True;0;0;0;False;0;False;0;0.6265677;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;16;-517.1174,66.93765;Inherit;True;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;24;-1414.748,27.34249;Inherit;True;Property;_warningtornadotextura2;warning tornado textura2;3;0;Create;True;0;0;0;False;0;False;-1;8ec9938f6f26af64eba4bec9de3de428;8ec9938f6f26af64eba4bec9de3de428;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;60;-1642.406,71.0199;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;13;-1996.812,-55.93054;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-2172.81,-23.93053;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleTimeNode;15;-2396.807,-71.93042;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;17;-2412.806,24.06894;Inherit;False;Property;_speed1;speed;0;0;Create;True;0;0;0;False;0;False;0,0;0,-1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.FunctionNode;53;-2734.493,322.9898;Inherit;True;Twirl;-1;;2;90936742ac32db8449cd21ab6dd337c8;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT;0;False;4;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;49;-3036.364,498.0855;Inherit;False;Constant;_strengthT;strengthT;10;0;Create;True;0;0;0;False;0;False;12.92;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;50;-3281.755,411.7992;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;51;-3582.923,375.0291;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;52;-3499.441,533.753;Inherit;False;Constant;_speedT;speedT;10;0;Create;True;0;0;0;False;0;False;-10;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;54;-3221.645,199.4405;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RotatorNode;55;-2945.259,268.4962;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0.5,0.5;False;2;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.WireNode;56;-2634.552,227.6978;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.LerpOp;48;-2329.98,306.1568;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;57;-2630.199,684.3517;Inherit;False;Property;_intensidad3;intensidad2;4;0;Create;True;0;0;0;False;0;False;1;0.4030561;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;63;-1936.637,224.1808;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;64;-2127.114,538.8583;Inherit;False;Constant;_ScaleN;ScaleN;5;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;26;-944.6557,-298.2719;Inherit;False;Constant;_Color0;Color 0;5;0;Create;True;0;0;0;False;0;False;1,0.8404344,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;18;-939.1314,-527.8884;Inherit;False;Constant;_Color3;Color 1;2;1;[HDR];Create;True;0;0;0;False;0;False;2.870588,0.07514629,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=C59BD31EFA158AA42045C58F56090B4811CC5191