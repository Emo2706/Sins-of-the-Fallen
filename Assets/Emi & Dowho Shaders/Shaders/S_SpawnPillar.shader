	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float time26 = ( _TimeParameters.x * _VoronoiSpeed );
				float2 voronoiSmoothId26 = 0;
				float2 coords26 = IN.ase_texcoord3.xy * _VoronoiScale;
				float2 id26 = 0;
				float2 uv26 = 0;
				float voroi26 = voronoi26( coords26, time26, id26, uv26, 0, voronoiSmoothId26 );
				float temp_output_34_0 = ( 1.0 - voroi26 );
				float2 texCoord13 = IN.ase_texcoord3.xy * _Tiling + ( _TimeParameters.x * _Offset );
				float2 panner14 = ( 1.0 * _Time.y * _Speed + texCoord13);
				float4 temp_output_12_0 = ( _Color0 * ( ( ( _Float1 - ( 1.0 - pow( texCoord19.y , _MaskOffset ) ) ) + temp_output_34_0 ) * ( tex2D( _TextureSample0, panner14 ) * temp_output_34_0 * _Intensitymask ) ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = temp_output_12_0.rgb;
				float Alpha = temp_output_12_0.r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float time26 = ( _TimeParameters.x * _VoronoiSpeed );
				float2 voronoiSmoothId26 = 0;
				float2 coords26 = IN.ase_texcoord2.xy * _VoronoiScale;
				float2 id26 = 0;
				float2 uv26 = 0;
				float voroi26 = voronoi26( coords26, time26, id26, uv26, 0, voronoiSmoothId26 );
				float temp_output_34_0 = ( 1.0 - voroi26 );
				float2 texCoord13 = IN.ase_texcoord2.xy * _Tiling + ( _TimeParameters.x * _Offset );
				float2 panner14 = ( 1.0 * _Time.y * _Speed + texCoord13);
				float4 temp_output_12_0 = ( _Color0 * ( ( ( _Float1 - ( 1.0 - pow( texCoord19.y , _MaskOffset ) ) ) + temp_output_34_0 ) * ( tex2D( _TextureSample0, panner14 ) * temp_output_34_0 * _Intensitymask ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float time26 = ( _TimeParameters.x * _VoronoiSpeed );
				float2 voronoiSmoothId26 = 0;
				float2 coords26 = IN.ase_texcoord.xy * _VoronoiScale;
				float2 id26 = 0;
				float2 uv26 = 0;
				float voroi26 = voronoi26( coords26, time26, id26, uv26, 0, voronoiSmoothId26 );
				float temp_output_34_0 = ( 1.0 - voroi26 );
				float2 texCoord13 = IN.ase_texcoord.xy * _Tiling + ( _TimeParameters.x * _Offset );
				float2 panner14 = ( 1.0 * _Time.y * _Speed + texCoord13);
				float4 temp_output_12_0 = ( _Color0 * ( ( ( _Float1 - ( 1.0 - pow( texCoord19.y , _MaskOffset ) ) ) + temp_output_34_0 ) * ( tex2D( _TextureSample0, panner14 ) * temp_output_34_0 * _Intensitymask ) ) );
				

				surfaceDescription.Alpha = temp_output_12_0.r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float time26 = ( _TimeParameters.x * _VoronoiSpeed );
				float2 voronoiSmoothId26 = 0;
				float2 coords26 = IN.ase_texcoord1.xy * _VoronoiScale;
				float2 id26 = 0;
				float2 uv26 = 0;
				float voroi26 = voronoi26( coords26, time26, id26, uv26, 0, voronoiSmoothId26 );
				float temp_output_34_0 = ( 1.0 - voroi26 );
				float2 texCoord13 = IN.ase_texcoord1.xy * _Tiling + ( _TimeParameters.x * _Offset );
				float2 panner14 = ( 1.0 * _Time.y * _Speed + texCoord13);
				float4 temp_output_12_0 = ( _Color0 * ( ( ( _Float1 - ( 1.0 - pow( texCoord19.y , _MaskOffset ) ) ) + temp_output_34_0 ) * ( tex2D( _TextureSample0, panner14 ) * temp_output_34_0 * _Intensitymask ) ) );
...
Node;AmplifyShaderEditor.ColorNode;11;-644.3195,-183.8501;Inherit;False;Property;_Color0;Color 0;1;1;[HDR];Create;True;0;0;0;False;0;False;333.8545,115.3633,31.46273,0;0.7490196,0.2588235,0.07450981,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;14;-1627.416,40.04656;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;13;-1921.047,-13.3443;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;16;-2142.843,-79.50799;Inherit;False;Property;_Tiling;Tiling;3;0;Create;True;0;0;0;False;0;False;1,1;0.5,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;18;-1845.841,183.492;Inherit;False;Property;_Speed;Speed;5;0;Create;True;0;0;0;False;0;False;0,-1;0,-0.6;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SamplerNode;15;-1386.415,28.34649;Inherit;True;Property;_TextureSample0;Texture Sample 0;2;0;Create;True;0;0;0;False;0;False;-1;f940116f31402cf4b8d60173df981dda;f940116f31402cf4b8d60173df981dda;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-362.843,-24.64422;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;-2093.015,125.0866;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleTimeNode;24;-2337.015,102.0866;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;17;-2329.843,200.492;Inherit;False;Property;_Offset;Offset;4;0;Create;True;0;0;0;False;0;False;1,1;0.3,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;23;-854.5912,-56.71922;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;-1039.684,159.6705;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleTimeNode;28;-2055.917,285.8851;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;34;-1348.152,266.504;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VoronoiNode;26;-1584.225,260.6482;Inherit;True;0;0;1;0;1;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;-1853.789,349.4568;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;31;-2069.208,420.5814;Inherit;False;Property;_VoronoiSpeed;Voronoi Speed;8;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-1816.584,468.0598;Inherit;False;Property;_VoronoiScale;Voronoi Scale;7;0;Create;True;0;0;0;False;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-342,79.5;Inherit;False;Property;_Clip;Clip;0;0;Create;True;0;0;0;False;0;False;0;0.4666978;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;19;-2151.767,-330.4784;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PowerNode;20;-1814.565,-302.6783;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;3.05;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-2105.859,-191.4139;Inherit;False;Property;_MaskOffset;Mask Offset;6;0;Create;True;0;0;0;False;0;False;0.33;-0.97;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;21;-1546.946,-273.8148;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;80;-1383.974,-280.7393;Inherit;True;2;0;FLOAT;-1.18;False;1;FLOAT;0.2;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;81;-1543.536,-376.7797;Inherit;False;Property;_Float1;Float 1;9;0;Create;True;0;0;0;False;0;False;-1;-1.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;78;-1137.167,-185.7402;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;83;-1156.598,314.3354;Inherit;False;Property;_Intensitymask;Intensity mask;10;0;Create;True;0;0;0;False;0;False;4.43;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;S_SpawnPillar;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;23;Surface;0;638353434316813466;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;False;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=53305869020F8176020C4B0F34D64C3BC4DD981C