...
Shader "S_disco"
{
	Properties
	{
		...
		[ASEBegin]_speed1("speed", Vector) = (0,0,0,0)
		_clip("clip", Range( 0 , 1)) = 0
		_scale("scale", Range( 0 , 1)) = 0
		[ASEEnd]_shockwavefarotextura2("shockwave faro textura2", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			sampler2D _shockwavefarotextura2;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 color15 = IsGammaSpace() ? float4(2.357125,1.388792,2.433572,0) : float4(6.595407,2.059691,7.075177,0);
				float2 texCoord10 = IN.ase_texcoord3.xy * float2( 1,1 ) + ( _TimeParameters.x * _speed1 );
				float4 tex2DNode18 = tex2D( _shockwavefarotextura2, texCoord10 );
				float4 lerpResult17 = lerp( float4( 0,0,0,0 ) , color15 , tex2DNode18);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = lerpResult17.rgb;
				float Alpha = saturate( ( 1.0 - step( tex2DNode18.r , _scale ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord10 = IN.ase_texcoord2.xy * float2( 1,1 ) + ( _TimeParameters.x * _speed1 );
				float4 tex2DNode18 = tex2D( _shockwavefarotextura2, texCoord10 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord10 = IN.ase_texcoord.xy * float2( 1,1 ) + ( _TimeParameters.x * _speed1 );
				float4 tex2DNode18 = tex2D( _shockwavefarotextura2, texCoord10 );
				

				surfaceDescription.Alpha = saturate( ( 1.0 - step( tex2DNode18.r , _scale ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord10 = IN.ase_texcoord1.xy * float2( 1,1 ) + ( _TimeParameters.x * _speed1 );
				float4 tex2DNode18 = tex2D( _shockwavefarotextura2, texCoord10 );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;S_disco;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;23;Surface;1;638429272408666415;  Blend;0;0;Two Sided;0;638429272428166191;Forward Only;0;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;1,False,;0;  Type;0;0;  Tess;3,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;False;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;10;-1445.704,66.30046;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-1621.704,98.30043;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleTimeNode;12;-1845.701,50.30056;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;13;-794.8806,156.547;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;14;-1861.701,146.2999;Inherit;False;Property;_speed1;speed;0;0;Create;True;0;0;0;False;0;False;0,0;0,-3;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.ColorNode;15;-1007.774,-209.4489;Inherit;False;Constant;_Color3;Color 1;2;1;[HDR];Create;True;0;0;0;False;0;False;2.357125,1.388792,2.433572,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;17;-555.9733,-191.7685;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;18;-1149.43,40.29254;Inherit;True;Property;_shockwavefarotextura2;shockwave faro textura2;3;0;Create;True;0;0;0;False;0;False;-1;684e7608697732f44987b60a6e7f5b46;684e7608697732f44987b60a6e7f5b46;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;20;-1143.821,312.995;Inherit;False;Property;_scale;scale;2;0;Create;True;0;0;0;False;0;False;0;0.6936954;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;16;-558.6188,166.3607;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;22;-332.5983,139.2182;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-321.0388,430.9023;Inherit;False;Property;_clip;clip;1;0;Create;True;0;0;0;False;0;False;0;0.5761805;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=D35346A0A64F1168C411D4FE3321B2889597541D