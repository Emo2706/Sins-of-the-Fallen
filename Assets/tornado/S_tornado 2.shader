...
Shader "S_tornado 2"
{
	Properties
	{
		...
		_twirlspeed("twirl speed", Vector) = (3,3,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 color33 = IsGammaSpace() ? float4(0,0.09411765,2.996078,0) : float4(0,0.009134057,11.17936,0);
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float3 ase_worldNormal = IN.ase_texcoord3.xyz;
				float fresnelNdotV29 = dot( ase_worldNormal, ase_worldViewDir );
				float fresnelNode29 = ( 0.0 + _scaleF * pow( 1.0 - fresnelNdotV29, _power ) );
				float4 lerpResult32 = lerp( float4( 0,0,0,0 ) , color33 , fresnelNode29);
				...
				float simplePerlin2D21 = snoise( appendResult44_g1*5.0 );
				simplePerlin2D21 = simplePerlin2D21*0.5 + 0.5;
				float4 lerpResult27 = lerp( float4( 0,0,0,0 ) , lerpResult32 , simplePerlin2D21);
				float4 effect35 = lerpResult27;
				float4 color18 = IsGammaSpace() ? float4(1.304119,0.8125139,0,0) : float4(1.793485,0.6252556,0,0);
				float2 texCoord15 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner14 = ( 1.0 * _Time.y * _speedT + texCoord15);
				float4 tex2DNode10 = tex2D( _efectotornado, panner14 );
				float4 lerpResult17 = lerp( color18 , float4( 0,0,0,0 ) , tex2DNode10);
				
				float4 temp_cast_1 = (_scale).xxxx;
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( effect35 + lerpResult17 ).rgb;
				float Alpha = ( step( tex2DNode10 , temp_cast_1 ) + effect35 ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float Alpha = ( step( tex2DNode10 , temp_cast_0 ) + effect35 ).r;
				float AlphaClipThreshold = _clip;
				float AlphaClipThresholdShadow = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = ( step( tex2DNode10 , temp_cast_0 ) + effect35 ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float fresnelNdotV29 = dot( IN.normalWS, ase_worldViewDir );
				float fresnelNode29 = ( 0.0 + _scaleF * pow( 1.0 - fresnelNdotV29, _power ) );
				float4 lerpResult32 = lerp( float4( 0,0,0,0 ) , color33 , fresnelNode29);
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;S_tornado 2;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;23;Surface;0;0;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;False;True;True;True;True;False;;False;0
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-355.1891,396.7659;Inherit;False;Property;_clip;clip;2;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;10;-1630.23,-35.82841;Inherit;True;Property;_efectotornado;efecto tornado;0;0;Create;True;0;0;0;False;0;False;-1;e919dd5dc0c5bd04288d3145761e26df;e919dd5dc0c5bd04288d3145761e26df;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StepOpNode;11;-1214.232,108.1716;Inherit;True;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-1598.23,236.1713;Inherit;False;Property;_scale;scale;4;0;Create;True;0;0;0;False;0;False;0;0.1848504;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;14;-1915.071,-23.79693;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;15;-2258.002,-59.44568;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;16;-2205.237,87.10924;Inherit;False;Property;_speedT;speedT;1;0;Create;True;0;0;0;False;0;False;0,0;0,-1.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleAddOpNode;36;-710.015,89.65593;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;34;-965.7664,247.9872;Inherit;False;35;effect;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;18;-1524.635,-256.8148;Inherit;False;Constant;_Color0;Color 0;4;1;[HDR];Create;True;0;0;0;False;0;False;1.304119,0.8125139,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;17;-1170.816,-187.3412;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;38;-559.4999,-159.7005;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;37;-791.1575,-245.4844;Inherit;False;35;effect;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;33;-1430.929,401.6671;Inherit;False;Constant;_Color1;Color 0;6;1;[HDR];Create;True;0;0;0;False;0;False;0,0.09411765,2.996078,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FresnelNode;29;-1522.469,638.1153;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;30;-1744.24,762.6805;Inherit;False;Property;_power;power;5;0;Create;True;0;0;0;False;0;False;2.02;1.54;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;31;-1771.842,645.3113;Inherit;False;Property;_scaleF;scaleF;6;0;Create;True;0;0;0;False;0;False;0;0.4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;32;-1155.552,651.2863;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;35;-247.1593,787.5212;Inherit;False;effect;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleTimeNode;23;-2169.025,987.578;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;20;-1662.906,984.3148;Inherit;True;Twirl;-1;;1;90936742ac32db8449cd21ab6dd337c8;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT;0;False;4;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;21;-1298.555,938.0914;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;-1830.584,1119.807;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;24;-1895.71,895.759;Inherit;False;Constant;_twirlcenter;twirl center;2;0;Create;True;0;0;0;False;0;False;7.3,5.46;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;25;-1895.123,1033.899;Inherit;False;Constant;_strengthtwirl;strength twirl;2;0;Create;True;0;0;0;False;0;False;0.4;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;26;-1467.463,1239.305;Inherit;False;Constant;_scalenoise;scale noise;2;0;Create;True;0;0;0;False;0;False;5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;27;-675.114,772.516;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.Vector2Node;28;-2056.692,1135.312;Inherit;False;Property;_twirlspeed;twirl speed;3;0;Create;True;0;0;0;False;0;False;3,3;3,3;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
ASEEND*/
//CHKSM=187D37758BBD3E6664400FA395DF0E0DC2980157