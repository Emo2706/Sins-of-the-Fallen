...
Shader "S_tornado 3"
{
	Properties
	{
		...
		[ASEBegin]_twirlspeed1("twirl speed", Vector) = (3,3,0,0)
		_freq1("freq", Float) = 0
		_speed1("speed", Float) = 0
		_diffStep1("diffStep", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 color32 = IsGammaSpace() ? float4(0.4823529,0.1444343,0,0) : float4(0.1980693,0.01835328,0,0);
				float temp_output_12_0 = sin( ( ( WorldPosition.y * _freq1 ) + ( _speed1 * _TimeParameters.x ) ) );
				float2 texCoord47_g6 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 center45_g6 = float2( 7.3,5.46 );
				float2 delta6_g6 = ( texCoord47_g6 - center45_g6 );
				float angle10_g6 = ( length( delta6_g6 ) * 0.21 );
				float x23_g6 = ( ( cos( angle10_g6 ) * delta6_g6.x ) - ( sin( angle10_g6 ) * delta6_g6.y ) );
				float2 break40_g6 = center45_g6;
				float2 break41_g6 = ( _TimeParameters.x * _twirlspeed1 );
				...
				float simplePerlin2D23 = snoise( appendResult44_g6*5.0 );
				simplePerlin2D23 = simplePerlin2D23*0.5 + 0.5;
				float temp_output_3_0_g5 = ( temp_output_12_0 - simplePerlin2D23 );
				float temp_output_3_0_g4 = ( ( temp_output_12_0 + _diffStep1 ) - simplePerlin2D23 );
				float temp_output_28_0 = ( saturate( ( temp_output_3_0_g5 / fwidth( temp_output_3_0_g5 ) ) ) - saturate( ( temp_output_3_0_g4 / fwidth( temp_output_3_0_g4 ) ) ) );
				float4 lerpResult31 = lerp( float4( 0,0,0,0 ) , color32 , temp_output_28_0);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = lerpResult31.rgb;
				float Alpha = ( 1.0 - step( temp_output_28_0 , _scale ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float temp_output_12_0 = sin( ( ( ase_worldPos.y * _freq1 ) + ( _speed1 * _TimeParameters.x ) ) );
				float2 texCoord47_g6 = IN.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 center45_g6 = float2( 7.3,5.46 );
				float2 delta6_g6 = ( texCoord47_g6 - center45_g6 );
				float angle10_g6 = ( length( delta6_g6 ) * 0.21 );
				float x23_g6 = ( ( cos( angle10_g6 ) * delta6_g6.x ) - ( sin( angle10_g6 ) * delta6_g6.y ) );
				...
				surfaceDescription.Alpha = ( 1.0 - step( temp_output_28_0 , _scale ) );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;S_tornado 3;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;23;Surface;0;0;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;False;True;True;True;True;False;;False;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;10;-3255.708,681.3923;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-2986.171,539.4025;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode;12;-2541.585,405.6026;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;13;-2349.53,397.3936;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-3315.623,450.6925;Inherit;False;Property;_freq1;freq;1;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;15;-2017.208,275.5446;Inherit;True;Step Antialiasing;-1;;4;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;-3001.345,404.4806;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;17;-2752.521,418.7996;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-3251.367,566.8615;Inherit;False;Property;_speed1;speed;2;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;20;-2009.772,-33.05846;Inherit;True;Step Antialiasing;-1;;5;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;21;-3942.113,-114.5704;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;22;-3435.995,-117.8335;Inherit;True;Twirl;-1;;6;90936742ac32db8449cd21ab6dd337c8;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT;0;False;4;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;24;-3603.672,17.65858;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;25;-3668.798,-206.3884;Inherit;False;Constant;_twirlcenter1;twirl center;2;0;Create;True;0;0;0;False;0;False;7.3,5.46;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;26;-3668.211,-68.24839;Inherit;False;Constant;_strengthtwirl1;strength twirl;2;0;Create;True;0;0;0;False;0;False;0.21;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;28;-1454.395,-50.87242;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;29;-3829.78,33.16358;Inherit;False;Property;_twirlspeed1;twirl speed;0;0;Create;True;0;0;0;False;0;False;3,3;3,3;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;30;-2560.466,526.6445;Inherit;False;Property;_diffStep1;diffStep;3;0;Create;True;0;0;0;False;0;False;0;-0.26;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;31;-820.6648,-169.2556;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;32;-1273.989,-321.1185;Inherit;False;Constant;_Color0;Color 0;4;0;Create;True;0;0;0;False;0;False;0.4823529,0.1444343,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StepOpNode;33;-955.0399,223.7444;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;34;-1311.519,389.0997;Inherit;False;Property;_scale;scale;4;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;35;-331.8536,243.2608;Inherit;False;Property;_clip;clip;5;0;Create;True;0;0;0;False;0;False;0;0.07419264;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;36;-596.8466,195.2818;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;23;-2912.852,-106.7147;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-3240.552,137.1565;Inherit;False;Constant;_scalenoise1;scale noise;2;0;Create;True;0;0;0;False;0;False;5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;19;-3321.753,270.7796;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
ASEEND*/
//CHKSM=22E519604BA57F090BB3262EA810C41F33EC90BE